...
title: Explore LangChain job opportunities
model: claude-opus-4-7[1m]
session_id: b7a36772-7890-46b9-b2ae-e74277681e5d
---

## User (2026-04-25T10:12:11)

https://www.langchain.com/careers#explore-jobs
...
## Assistant (2026-04-25T10:16:05)

I have enough position data to build the deck. Let me consolidate and create it now.

---

## Assistant (2026-04-25T10:19:23)

Slide 4's title overflows into the subtitle. Let me fix it.

---

## Assistant (2026-04-25T10:19:56)

Slide 4 is fixed. Now let me copy the final deck to the project folder.

---

## Assistant (2026-04-25T10:20:20)

[View your presentation](computer:///Users/swbs/Documents/Claude/Projects/langchain%20open%20positions/LangChain_Open_Positions.pptx)

11 slides covering ~57 open roles, organized as: title with stats → hiring overview chart → Engineering (Open Source, LangSmith Platform, Applied AI/Customer) → Deployed Engineering with city map → Sales (Account Executives, GTM Ops) → Marketing → Product/Recruiting/Operations → apply links. Built in LangChain's signature lime-on-deep-green palette.

A note on sourcing: langchain.com and the Ashby job board aren't on the network allowlist, so I assembled the role list by stitching together a dozen targeted searches against `site:jobs.ashbyhq.com/langchain`. The titles and locations are accurate as of those search snippets, but a handful of regional variants (Phoenix/Denver/Seattle Deployed Engineer roles, for example) may have been added or removed since — recommend a quick spot-check against the live board before sharing externally.

Sources:
- [LangChain Careers](https://www.langchain.com/careers)
- [LangChain Jobs (Ashby)](https://jobs.ashbyhq.com/langchain)
- [LangChain Jobs & Careers — 39 Open Positions](https://underprompt.com/companies/langchain)
